...
namespace faster_gs::rasterization {
    ...
    struct PrimitiveBuffersSplitSorting {
        size_t cub_workspace_size;
        char* cub_workspace;
        ...
        static PrimitiveBuffersSplitSorting from_blob(char*& blob, int n_primitives) {
            PrimitiveBuffersSplitSorting buffers;
    ...
    struct TileBuffers {
        ...
        // the following buffers are needed for the per gaussian backward pass
        size_t cub_workspace_size = 0;
        char* cub_workspace = nullptr;
        uint* n_buckets = nullptr;
        uint* buckets_offset = nullptr;
        uint* max_n_processed = nullptr;
        uint* n_processed = nullptr;

        static TileBuffers from_blob(char*& blob, int n_tiles, bool use_per_gaussian_backward) {
            TileBuffers buffers;
